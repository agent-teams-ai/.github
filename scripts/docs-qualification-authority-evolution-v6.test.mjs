...
const workflowPath = ".github/workflows/docs-qualification-authority-evolution-v6.yml";
const testPath = "scripts/docs-qualification-authority-evolution-v6.test.mjs";
...
const canonical = [
  [".github/workflows/docs-protocol-check.yml", "modified", "153bd51c35aa079389f292588b56a03a276db386"],
  ["scripts/check-community-files.mjs", "modified", "cc032cd1f28bb2421553c6818991e5c6e0241c67"],
  ["scripts/check-community-files.test.mjs", "modified", "9f196d2c9ea3bce557282fb03ef89cf54599d518"],
...
test("accepts only the exact workflow-context authority slice", async () => {
