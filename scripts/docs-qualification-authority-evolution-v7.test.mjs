...
const workflowPath = ".github/workflows/docs-qualification-authority-evolution-v7.yml";
const testPath = "scripts/docs-qualification-authority-evolution-v7.test.mjs";
...
const canonical = [
  ["scripts/verify-docs-qualification-receipt.mjs", "modified", "bbeedf26d12dd3b4b6c8ab681d37f348069a0e37"],
  ["scripts/verify-docs-qualification-receipt.test.mjs", "modified", "ccb5336eb66d937b7b9109503289b0a3253dd376"],
...
test("accepts only the exact qualification-receipt authority slice", async () => {
