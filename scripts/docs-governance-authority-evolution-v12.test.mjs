...
const workflowPath = ".github/workflows/docs-governance-authority-evolution-v12.yml";
const testPath = "scripts/docs-governance-authority-evolution-v12.test.mjs";
...
const canonical = [
  ["scripts/docs-cohort-policy.mjs", "a4068654c6966158cd4b64f45011a0479d640a32"],
  ["scripts/docs-cohort-policy.test.mjs", "21bbb9230904f8797180e6bb2d5994a0dade3ed9"],
...
test("accepts only the exact exception review-date boundary slice", async () => {
