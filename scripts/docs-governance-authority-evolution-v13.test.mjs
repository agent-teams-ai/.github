...
const workflowPath = ".github/workflows/docs-governance-authority-evolution-v13.yml";
const testPath = "scripts/docs-governance-authority-evolution-v13.test.mjs";
...
test("accepts only the exact exception boundary-test decoupling slice", async () => {
